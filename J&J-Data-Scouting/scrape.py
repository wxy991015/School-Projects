...
#These Two lines are used to set the name of the target company and their websites URL
...
print()
print("--------------------------------------------------------------------------------")
print("Now parsing the retrieved data. This may take a while.")
print("--------------------------------------------------------------------------------")
print()
...
#Bellow are the print statements that display the results of the scrape
print("")
print("")
print("")
